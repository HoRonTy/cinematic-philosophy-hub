...
const charactersData = {
  ...
  "morpheus": {
    ...
    philosophy: "ываМорфеус олицетворяет поиск истины и освобождение сознания. Он верит, что реальность может быть иллюзией, и что истинная свобода начинается с принятия этой возможности.",
    quotes: [
